...
export const upanishads: Upanishad[] = [
  ...
  },
  {
    ...
    teaching: 'The five sheaths (koshas): food, breath, mind, understanding and bliss. Also the graduate’s charge: “speak the truth, practise dharma”, “treat mother, father, teacher and guest as gods.”',
  ...
  },
  {
    ...
    teaching: 'The Self is known only as “not this, not this” (neti neti). It is the seer of seeing, the knower of knowing. Also: the 33 gods, and the prayer from the unreal to the real.',
  ...
  },
  {
    ...
    teaching: 'The one God, Rudra-Shiva, rules nature (prakriti) and souls. The first text to join Samkhya, Yoga and devotion to a personal God; the word “bhakti” appears in its last verse.',
    famous: { iast: 'eko devaḥ sarvabhūteṣu gūḍhaḥ', meaning: 'The one God hidden in all beings.', ref: 'Shvetashvatara 6.11' },
...
export const gitaChapters: { n: number; name: string; sanskrit: string; verses: number; theme: string; key: { ref: string; iast: string; meaning: string } }[] = [
  ...
  { n: 12, name: 'Bhakti Yoga', sanskrit: 'भक्तियोग', verses: 20, theme: 'Devotion: the qualities of the devotee dear to God.', key: { ref: '12.13', iast: 'adveṣṭā sarva-bhūtānāṃ maitraḥ karuṇa eva ca', meaning: 'Without hatred for any being, friendly and compassionate.' } },
