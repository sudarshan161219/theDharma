...
export const kuladevatas: KulaDeity[] = [
  ...
  k({ id: 'mahalasa', name: 'Mahalasa Narayani', form: 'Mohini (Vishnu) as the Goddess', place: 'Mardol, Ponda', state: 'Goa', region: 'West', lat: 15.4222, lng: 73.9776, heldBy: 'Kuladevi of many Gaud Saraswat families. She is related to Khandoba’s consort Mhalsa.', text: 'Vishnu’s enchanting Mohini form, worshipped as the Goddess.', sources: [defn('mahalasa', 'Mahalasa')] }),
  ...
  k({ id: 'bahuchara', name: 'Bahuchara Mata', form: 'Form of Durga, riding a rooster', place: 'Becharaji', state: 'Gujarat', region: 'West', lat: 23.4983, lng: 72.0428, heldBy: 'Kuladevi of many Gujarati communities; patron goddess of the hijra community.', text: 'One of Gujarat’s great Goddess seats, near Modhera.', sources: [src.conceptKuladevi] }),
  k({ id: 'ashapura', name: 'Ashapura Mata', form: 'Goddess who fulfils hopes', place: 'Mata no Madh, Kutch', state: 'Gujarat', region: 'West', lat: 23.5361, lng: 68.9364, heldBy: 'Kuladevi of the Jadejas of Kutch, many Chauhan lineages and others.', text: 'Worshipped as a seven-eyed form in red. Her name means “she who fulfils hopes” (asha).', sources: [src.conceptKuladevi] }),
  ...
  k({ id: 'shakambhari', name: 'Shakambhari', form: 'The Goddess who feeds with vegetables', place: 'Sambhar', state: 'Rajasthan', region: 'West', lat: 26.8862, lng: 75.1861, heldBy: 'Kuladevi of the Chauhans (Chahamanas), whose early capital was named after her.', text: 'The incarnation foretold in the Devi Mahatmya, who fed the world from her own body during a drought.', sources: [src.defShakambhari, src.dmCanto91] }),
  ...
  k({ id: 'mookambika', name: 'Mookambika', form: 'Durga, Lakshmi and Sarasvati in one', place: 'Kollur', state: 'Karnataka', region: 'South', lat: 13.8642, lng: 74.8144, heldBy: 'Kuladevi of many families of coastal Karnataka and Kerala.', text: 'The Goddess who struck the demon Kaumasura dumb (muka). A jyotirlinga-shaped stone holds both Shiva and Shakti.', sources: [src.conceptKuladevi] }),
...
const DEVI = 'Adi Shakti (the Goddess)';
...
export const SUPREME_INFO: Record<Supreme, { title: string; text: string }> = {
  ...
  Devi: {
    title: 'Forms of the Goddess (Devi / Shakti)',
    text: 'Most kuladevis are forms of the one Goddess. Shakta scripture sees her as supreme; Shaiva and Vaishnava scripture see her as the power (shakti) of Shiva or of Vishnu.',
  },
};
