...
export const src = {
  ...
  // ——— Kashmir Shaivism ———
  defKashmirShaivism: { label: 'Kashmir Shaivism — definitions', url: `${WL}/definition/kashmir-shaivism` },
  pratyabhijnaAdvaita: { label: 'Pratyabhijna and Shankara’s Advaita (comparative study)', url: `${WL}/hinduism/essay/pratyabhijna-and-shankara-advaita-study` },
  ksOrigin: { label: 'Pratyabhijna and Advaita 3 — Origin and development of Kashmir Shaivism', url: `${WL}/hinduism/essay/pratyabhijna-and-shankara-advaita-study/d/doc1460614.html` },
  ksSchools: { label: 'Pratyabhijna and Advaita 4 — Various schools of Kashmir Shaivism', url: `${WL}/hinduism/essay/pratyabhijna-and-shankara-advaita-study/d/doc1460615.html` },
  ksPinnacle: { label: 'Pratyabhijna and Advaita 5 — Pratyabhijna: the pinnacle of Kashmir Shaivism', url: `${WL}/hinduism/essay/pratyabhijna-and-shankara-advaita-study/d/doc1460620.html` },
  ksOntology: { label: 'Pratyabhijna and Advaita — Ontology of Pratyabhijna and Advaita', url: `${WL}/hinduism/essay/pratyabhijna-and-shankara-advaita-study/d/doc1460625.html` },
  ksMayaAssociates: { label: 'Pratyabhijna and Advaita — Associates of Maya (kanchukas and malas)', url: `${WL}/hinduism/essay/pratyabhijna-and-shankara-advaita-study/d/doc1460666.html` },
  ksTattvas: { label: 'Gitartha-samgraha study — Tattvas of Kashmir Shaivism', url: `${WL}/hinduism/essay/gitartha-samgraha-critical-study/d/doc1239318.html` },
  ksThirtySix: { label: 'Cidgaganacandrika study — The thirty-six tattvas of Shaivism', url: `${WL}/hinduism/book/cidgaganacandrika-study/d/doc629237.html` },
  ksMalas: { label: 'Cidgaganacandrika study — The three malas', url: `${WL}/hinduism/book/cidgaganacandrika-study/d/doc629228.html` },
  ksUpayas: { label: 'Cidgaganacandrika study — The upayas', url: `${WL}/hinduism/book/cidgaganacandrika-study/d/doc629229.html` },
  ksPerceivers: { label: 'Cidgaganacandrika study — The seven perceivers (pramatri)', url: `${WL}/hinduism/book/cidgaganacandrika-study/d/doc629240.html` },
  ksKrama: { label: 'Cidgaganacandrika study — The Krama system', url: `${WL}/hinduism/book/cidgaganacandrika-study/d/doc629242.html` },
  ksSpanda: { label: 'Cidgaganacandrika study — The Spanda system', url: `${WL}/hinduism/book/cidgaganacandrika-study/d/doc629251.html` },
  ksShaktiKrama: { label: 'Shakti in Kashmir Shaivism — Krama, an emergent of Kula', url: `${WL}/hinduism/essay/shakti-in-kashmir-shaivism-study/d/doc1597884.html` },
