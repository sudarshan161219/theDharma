...
| `src/data/epithets.ts` | Epithets of 45 devas, devis and avataras (the Trimurti and Shaktis, the 24 Keshavadi forms of Vishnu, the 32 forms and the avatars of Ganesha, Shiva’s forms, five faces and Ashtamurti, Ashtalakshmi, Bhudevi, Tulasi, Parvati, Durga, Navadurga, the Mahavidyas, the Matrikas, Kali, Sita, Radha, Ganga, all ten Dashavatara, Ganesha, Skanda, Hanuman and the Vedic devas): Devanagari, meaning, the story behind each, and the kind of name (deed, form, relation, quality, role, place). Shown at `#/epithets` |
