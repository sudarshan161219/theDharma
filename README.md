...
| `src/data/epithets.ts` | Epithets of 47 devas, devis and avataras (the Trimurti and Shaktis, the 24 Keshavadi forms of Vishnu, the 32 forms and the avatars of Ganesha, Shiva’s forms, five faces and Ashtamurti, Ashtalakshmi, Bhudevi, Tulasi, Parvati, Durga, Navadurga, the Mahavidyas, the Matrikas, Kali, Sita, Radha, Ganga, all ten Dashavatara, Krishna’s names, his names in the Gita and his temple forms, Ganesha, Skanda, Hanuman and the Vedic devas): Devanagari, meaning, the story behind each, and the kind of name (deed, form, relation, quality, role, place). Shown at `#/epithets` |
...
| `src/data/trika.ts` | Kashmir Shaivism: key aphorisms, the triads, the five schools (Kula, Krama, Spanda, Pratyabhijna, Trika), key ideas, Shiva’s five powers and five acts, the 36 tattvas, the three malas and seven perceivers, the four upayas, a comparison with Advaita, the teachers and the texts. Shown at `#/trika` |
| `src/data/siddhanta.ts` | Shaiva Siddhanta: Pati, pashu and pasha, the three causes, the bonds, the classes and states of the soul, Nataraja’s five acts, how grace comes, the four paths, the 36 tattvas as the Siddhanta groups them, the 28 Agamas by the five faces, the Shivajnanabodham’s twelve sutras, the Tirumurai, the teachers of both streams, and a three-way comparison. Shown at `#/siddhanta` |
| `src/data/vishishtadvaita.ts` | Vishishtadvaita: key verses as Ramanuja reads them, the three reals, the body–soul relation and key terms, the five forms of Narayana, the seven objections to avidya, the ways (bhakti, prapatti and their parts), the three secrets, liberation, the twelve Alvars, the acharyas and Ramanuja’s nine works, Vadakalai and Tenkalai, and a comparison of three Vedantas. Shown at `#/vishishtadvaita` |
| `src/data/dvaita.ts` | Dvaita: verses as Madhva reads them, Vyasatirtha’s nine truths, independent and dependent reality, the five differences, key ideas (bheda, bimba–pratibimba, taratamya, sakshi, vishesha), bhakti and the road to liberation, the debate with Advaita, the acharyas and Madhva’s works, Udupi and the Haridasas, and a comparison with Vishishtadvaita. Shown at `#/dvaita` |
