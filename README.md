...
| `src/data/epithets.ts` | Epithets of 19 devas, devis and avataras (Vishnu, Shiva, Parvati, Durga, Kali, Lakshmi, Sarasvati, Sita, Radha, Ganga, Brahma, Ganesha, Skanda, Krishna, Rama, Hanuman, Surya, Indra, Agni): Devanagari, meaning, the story behind each, and the kind of name (deed, form, relation, quality, role, place). Shown at `#/epithets` |
